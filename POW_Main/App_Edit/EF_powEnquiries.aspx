              ...
              <div id="accordion">
                <div class="card">
                  <div class="card-header">
                    <a class="card-link" data-toggle="collapse" href="#collapseOne">Click to Show or Hide Enquiry Details
                    </a>
                  </div>
                    ...
                    <ContentTemplate>
                      ...
                      <asp:GridView ID="GVpowOffers" SkinID="gv_silver" runat="server" DataSourceID="ODSpowOffers" DataKeyNames="TSID,EnquiryID,RecordID">
                        <Columns>
                          ...
                          <asp:TemplateField HeaderText="IDMS Receipt" SortExpression="ReceiptID">
                            <ItemTemplate>
                              <asp:Label ID="LabelReceiptID" runat="server" ForeColor='<%# EVal("ForeColor") %>' Text='<%# Bind("ReceiptID") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="alignCenter" />
                            <HeaderStyle CssClass="alignCenter" Width="50px" />
                          </asp:TemplateField>
                          <asp:TemplateField HeaderText="IDMS Revision" SortExpression="ReceiptRevision">
                            <ItemTemplate>
                              <asp:Label ID="LabelReceiptRevision" runat="server" ForeColor='<%# Eval("ForeColor") %>' Text='<%# Bind("ReceiptRevision") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="alignCenter" />
                            <HeaderStyle CssClass="alignCenter" Width="50px" />
                          </asp:TemplateField>
                          <asp:TemplateField HeaderText="Distributed On" SortExpression="DistributedOn">
                            <ItemTemplate>
                              <asp:Label ID="LabelDistributedOn" runat="server" ForeColor='<%# Eval("ForeColor") %>' Text='<%# Bind("DistributedOn") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="alignCenter" />
                          <HeaderStyle CssClass="alignCenter" Width="90px" />
                          </asp:TemplateField>
                          <asp:TemplateField HeaderText="Evaluated On" SortExpression="EValuatedOn">
                            <ItemTemplate>
                              <asp:Label ID="LabelEValuatedOn" runat="server" ForeColor='<%# EVal("ForeColor") %>' Text='<%# Bind("EValuatedOn") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="alignCenter" />
                          <HeaderStyle CssClass="alignCenter" Width="90px" />
                          </asp:TemplateField>
