...
var script_powEnquiries = {
    ...
    validate_TSID: function(sender) {
      ...
      this.validated_FK_POW_Enquiries_TSID_main = true;
      this.validate_FK_POW_Enquiries_TSID(sender,Prefix);
      },
    ...
    validate_FK_POW_Enquiries_TSID: function(o,Prefix) {
      var value = o.id;
      var TSID = $get(Prefix + 'TSID');
      if(TSID.value==''){
        if(this.validated_FK_POW_Enquiries_TSID_main){
      ...
      value = value + ',' + TSID.value ;
        ...
        PageMethods.validate_FK_POW_Enquiries_TSID(value, this.validated_FK_POW_Enquiries_TSID);
      },
    validated_FK_POW_Enquiries_TSID_main: false,
    validated_FK_POW_Enquiries_TSID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_powEnquiries.validated_FK_POW_Enquiries_TSID_main){
