Partial Class lgToolBar
  ...
  Public Event SaveAddClicked(ByVal sender As Object, ByVal e As System.EventArgs)
  Public Event UpdateClicked(ByVal sender As Object, ByVal e As System.EventArgs)

  Public ReadOnly Property AsScreen As String
    Get
      Dim mRet As String = "display:block;"
      Try
  ...
  End Property
    ...
    If tdDefault.Visible Then
      If CmdExit.Enabled Then CmdExit.CssClass = "btn btn-sm btn-success" Else CmdExit.CssClass = "btn btn-sm btn-outline-success"
      If CmdSave.Enabled Then CmdSave.CssClass = "btn btn-sm btn-primary" Else CmdSave.CssClass = "btn btn-sm btn-outline-primary"
      If CmdAdd.Enabled Then CmdAdd.CssClass = "btn btn-sm btn-warning" Else CmdAdd.CssClass = "btn btn-sm btn-outline-warning"
      If CmdDelete.Enabled Then CmdDelete.CssClass = "btn btn-sm btn-danger" Else CmdDelete.CssClass = "btn btn-sm btn-outline-danger"
      If CmdForward.Enabled Then CmdForward.CssClass = "btn btn-sm btn-info" Else CmdForward.CssClass = "btn btn-sm btn-outline-info"
      If CmdReturn.Enabled Then CmdReturn.CssClass = "btn btn-sm btn-danger" Else CmdReturn.CssClass = "btn btn-sm btn-outline-danger"
      If CmdPrint.Enabled Then CmdPrint.CssClass = "btn btn-sm btn-warning" Else CmdPrint.CssClass = "btn btn-sm btn-outline-Warning"
    End If
  ...
  End Property
	Public Property CancelUrl() As String
		...
		End Set
	End Property
  Protected Sub CmdCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdExit.Click
  ...
  End Sub
  Protected Sub CmdForward_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdForward.Click
    RaiseForwardClicked(sender, e)
  End Sub
  Protected Sub CmdReturn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdReturn.Click
    RaiseReturnClicked(sender, e)
  End Sub
  Protected Sub SearchButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdSearch.Click
  ...
  Protected Sub DisableSearch_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DisableSearch.CheckedChanged
	...
	End Sub
  Protected Sub navFirst_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles navFirst.Click
    RaisePageChanged(0, Convert.ToInt32(_PageSize.Text))
  End Sub
  Protected Sub navPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles navPrev.Click
    Dim cp As Integer = Convert.ToInt32(_CurrentPage.Text)
    If cp - 1 >= 1 Then
      RaisePageChanged(cp - 2, Convert.ToInt32(_PageSize.Text))
    End If
  End Sub
  Protected Sub navNext_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles navNext.Click
    Dim cp As Integer = Convert.ToInt32(_CurrentPage.Text)
    ...
    End If
  End Sub
  Protected Sub navLast_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles navLast.Click
    Dim lp As Integer = Convert.ToInt32(_TotalPages.Text)
